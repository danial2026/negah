...
## Overview
The Watchman has been completely refactored to use [Bubble Tea](https://github.com/charmbracelet/bubbletea) for a modern, interactive Terminal User Interface (TUI). The application now features a beautiful interface with clipboard support, styled output, and improved user experience.
